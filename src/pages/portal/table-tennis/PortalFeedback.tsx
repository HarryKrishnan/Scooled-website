  ...
  return (
    <div className="space-y-8 pb-12">
      <div className="card-premium border-orange-tile bg-black/95 mb-8">
        ...
        <p className="text-sm text-white/70 font-bold mt-1">Help us maintain the highest standards of Futsal excellence.</p>
      </div>
      ...
      <div className="grid lg:grid-cols-3 gap-8">
        ...
        <div className="space-y-6">
          ...
          <div className="card-premium bg-black/95 border-orange-tile shadow-2xl shadow-primary/5">
