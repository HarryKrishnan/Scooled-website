            ...
            >
              ...
              <div className="p-8 pt-4 border-t border-white/5 flex gap-4 bg-black/40">
                ...
                <button 
                  ...
                  className="flex-[2.5] py-5 rounded-2xl bg-gradient-to-r from-primary to-orange-500 text-white text-[10px] font-black uppercase tracking-[0.25em] shadow-2xl shadow-primary/20 hover:shadow-primary/40 hover:scale-[1.02] active:scale-95 transition-all disabled:opacity-20 disabled:grayscale disabled:scale-100"
                >
