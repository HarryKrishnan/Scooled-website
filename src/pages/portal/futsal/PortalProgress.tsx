    ...
    <div className="space-y-8 pb-10">
      ...
      <div className="card-premium border-orange-tile bg-black/95 mb-8 flex flex-col sm:flex-row sm:items-center justify-between gap-6">
        <div>
          ...
          <p className="text-sm text-white/70 font-bold mt-1">Deep dive into your Futsal performance and trends.</p>
        </div>
      ...
      <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-4">
        {[
          { label: "Programs Enrolled", value: userEnrollments.length, icon: Target, color: "text-primary", bg: "bg-primary/10", border: "border-orange-tile" },
        ...
        <div className="lg:col-span-1 space-y-6">
          <div className="card-premium border-gold-tile bg-black/95 h-full">
            ...
            <div className="space-y-4">
              {[
                { label: "Attendance Peak", desc: "Your attendance is 12% higher than average Athletes this month. Keep it up!", icon: TrendingUp, color: "text-green-500", bg: "bg-green-500/10" },
