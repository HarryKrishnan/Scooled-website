...
export default function PortalBookings() {
  ...
  return (
    <div className="space-y-10">
      <div className="card-premium border-blue-tile flex flex-col md:flex-row md:items-center justify-between gap-6 overflow-hidden relative">
        <div className="absolute -top-10 -right-10 w-40 h-40 bg-primary/10 rounded-full blur-3xl" />
        <div className="flex flex-col gap-1 relative z-10">
          <h1 className="font-display text-4xl font-bold text-white tracking-tight">Your Bookings</h1>
          <p className="text-white/70 font-semibold text-lg italic">View and manage your upcoming and past swim sessions.</p>
        </div>
      </div>
