...
export const userEnrollments = [
  ...
  },
  {
    ...
    attendanceRate: 95,
    nextSession: "Mon, 5:00 PM",
    progress: 60,
    lane: "Court 2",
    center: "Scooled — Westside",
    days: "Mon, Wed, Fri",
...
export const allSportPrograms: Record<string, SportProgram[]> = {
  ...
  Pickleball: [
    {
      id: "pb-p1",
      title: "Late Night Scrimmage",
      level: "Beginner",
      ageGroup: "6–12 years",
      schedule: "Friday, 9:00 PM",
      price: 2800,
      image: progPickleballCompetitive, // Using existing asset
      badge: "NEW",
      badgeColor: "bg-emerald-500",
      accentColor: "from-lime-600/80",
      description: "Friday night under the lights. Unlimited play for members.",
    },
    {
      id: "pb-p2",
      title: "Family Day Tournament",
      level: "All Levels",
      ageGroup: "All Ages",
      ...
      description: "Parent-child tournament every Sunday. Prizes to be won!",
    },
    {
      id: "pb-p3",
      title: "Competitive Pickleball",
